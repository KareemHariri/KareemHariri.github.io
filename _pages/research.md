...
![Integrated Squeezed Light Source]<img src="{{ '/images/On-Chip1.jpg' | relative_url }}" alt="On-Chip1" style="width:1000px; height:auto;">

### 3. Quantum Optical Gyroscope
**In preparation**

![Quantum-enhanced Resonant Fiber-Optic gyroscope]<img src="{{ '/images/gyro.jpg' | relative_url }}" alt="gyro" style="width:1000px; height:auto;">

### 4. Quantum Radar
a. **In review**

![Quantum vs Classical Radar]<img src="{{ '/images/5GQRadar.png' | relative_url }}" alt="5GRadar" style="width:1000px; height:auto;">

b. **Physical Review A 112, 052613  (2025)**

![Quantum Illumination]<img src="{{ '/images/QRadar.jpg' | relative_url }}" alt="QRadar" style="width:1000px; height:auto;">
