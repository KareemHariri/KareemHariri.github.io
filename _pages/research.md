...
My research interests lie at the frontier of light–matter interactions and span precision measurement, quantum optics, optical frequency metrology, atomic clocks, quantum-enhanced sensing, and integrated photonics. This page highlights selected research directions. See also [Publications](/publications/) and [Google Scholar](https://scholar.google.com/citations?user=vsb2i7oAAAAJ&hl=en) for a full publication list.
...
<div class="gallery-row">
    <div class="gallery-text">
      ...
      <p>
      <em><a href="https://journals.aps.org/prx/abstract/10.1103/plh2-cr8s">Physical Review X 15, 041009 (2025)</a> - Quantum Frequency Combs for Sensing</em><br>
...
<div class="gallery-row">
    <div class="gallery-text">
      ...
      <p>
           <em><a href="https://deepblue.lib.umich.edu/items/34bee350-e11d-4887-a0b2-1c46bb100bb6"> University of Michigan Library, Deeb Blue (2026) </a>- Quantum-Enhanced Metrology with Engineered Squeezed Light: From Spectroscopy to Inertial Sensing </em><br>
        <div style="height:1.5px;"></div>
...
Here, we introduce amplitude-squeezed light into the domain of resonant fiber optic gyroscopes, realizing a quantum-enhanced RFOG architecture compatible with conventional power levels and device components. By injecting a bright amplitude-squeezed beam into the sensing mode of a fiber ring resonator, we suppress the contribution of shot noise. This quantum-enhanced configuration yields a 2~dB reduction in detector noise floor, as confirmed by Allan deviation analysis. Operating under practical conditions, our system demonstrates the feasibility of leveraging squeezed light to enhance sensitivity in optical gyroscopes. Quantum-enhanced RFOGs thus represent a promising frontier for next-generation precision metrology and navigation technologies.
      </p>
    </div>
  ...
  <div class="gallery-row">
    <div class="gallery-text">
      ...
      <p>
         <em><a href="https://ieeexplore.ieee.org/document/11477857/keywords#keywords">a. IEEE Trans. Commun 3681651 (2026) </a>- Quantum Integrated Sensing and Communication </em><br>
        <div style="height:1.5px;"></div>
...
<div class="gallery-row">
    <div class="gallery-text">
      ...
      <p>
        <em><a href="https://journals.aps.org/pra/abstract/10.1103/PhysRevA.100.032119">Physical Review A 100, 032119  (2019) </a> - Schemes for measuring quantum systems </em><br>
        <div style="height:1.5px;"></div>
